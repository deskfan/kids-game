...
from characters import SCREEN_HEIGHT, SCREEN_WIDTH, Gem, Player, Villain
...
while running:
    ...
    ############### HANDLE COLLISIONS ###############################
    player_gets_gem1 = isCollision(
        player.rect.x, player.rect.y, gem1.rect.x, gem1.rect.y
    )
    player_gets_gem2 = isCollision(
        player.rect.x, player.rect.y, gem2.rect.x, gem2.rect.y
    )
    #    player_hit_villain = isCollision(player.rect.x,player.rect.y,villain.rect.x,villain.rect.y,80)
    villain_hit_gem1 = isCollision(
        gem1.rect.x, gem1.rect.y, villain.rect.x, villain.rect.y, 100
    )
    villain_hit_gem2 = isCollision(
        gem2.rect.x, gem2.rect.y, villain.rect.x, villain.rect.y, 100
    )
